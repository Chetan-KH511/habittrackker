...
extension AppsettingQuerySortBy
  ...
  QueryBuilder<Appsetting, Appsetting, QAfterSortBy> sortByFirstTimeLaunch() {
    return QueryBuilder.apply(this, (query) {
...
extension AppsettingQuerySortThenBy
  ...
  QueryBuilder<Appsetting, Appsetting, QAfterSortBy> thenByFirstTimeLaunch() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'firstTimeLaunch', Sort.asc);
    });
  }
...
extension AppsettingQueryWhereDistinct
  ...
  QueryBuilder<Appsetting, Appsetting, QDistinct> distinctByFirstTimeLaunch() {
    return QueryBuilder.apply(this, (query) {
